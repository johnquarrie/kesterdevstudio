export default function Head() {
  return (
    <>
      ...
      <meta name="twitter:image" content="https://www.kesterdevstudio.com/_next/static/media/hero-bg.9e63d430.svg" />
      <meta name="twitter:title" content="Kester Dev Studio" />
      <meta
        name="twitter:description"
        content="Kester Dev Studio is a software development studio that specializes in building custom software solutions for businesses."
      />
      <link rel="image_src" href="https://www.kesterdevstudio.com/_next/static/media/hero-bg.9e63d430.svg" />
