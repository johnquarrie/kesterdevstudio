...
const achi = ["/images/archi_4.webp", "/images/archi_6.jpg", "/images/archi_7.jpg", "/images/archi_8.webp", "/images/archi_9.webp"];
...
const ServicesHeader = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setIndex((prev) => (prev + 1) % achi.length);
    }, 6000); // longer feels smoother
      ...
      <div className="flex flex-col justify-center text-center items-center gap-4 w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%] z-10">
        ...
        >
          <h1 className="text-[1.6rem] max-2xs:leading-[1.2] 2xs:text-3xl xs:text-4xl 2xl:text-5xl font-future text-white">
            Sell the Vision Before the First Brick is Laid
          </h1>
          <p className="text-sm 2xs:text-base text-white/50 w-[90%] mt-4 lg:w-[80%] xl:w-[70%]">
            We help real estate companies attract serious buyers using immersive 3D visuals and conversion-focused landing pages
          </p>
          <AnimatedButton
            onClick={() => {
              navigate("/#contactUs");
